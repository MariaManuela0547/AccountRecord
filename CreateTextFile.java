...
public class CreateTextFile 
{
    ...
    //permite ao usuario abrir  arquivo
...
Scanner input = new Scanner(System.in);
    ...
    System.out.printf("%s\n%s\n%s\n%s\n\n", 
    "To terminate input, type the  and-of-file indicator",
    "when you are prompted to enter input.",
    "On UNIX/Linux/Mac OS X type <ctrl> z then press Enter",
    ...
    {
    if (output != null )
    output.close(); } // fim do método closeFile
